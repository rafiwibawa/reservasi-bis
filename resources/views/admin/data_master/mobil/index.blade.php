                  ...
                  <table class="table table-sm table-bordered table-hover" id="init-table" width="100%">
                      <thead class="thead-light">
                          <tr>
                              ...
                              <th width="20%">Merek Mobil</th> 
                              <th width="20%">Jumlah Kapasitas</th> 
                              <th width="20%">CC</th> 
                              <th width="5%">Aksi</th>
                          </tr>
                      </thead>
...
@include('admin.data_master.mobil.modal')
...
@include('admin.data_master.mobil.script')
